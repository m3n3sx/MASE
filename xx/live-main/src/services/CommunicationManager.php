...
class CommunicationManager {
        ...
        try {
            ...
            if ($is_success) {
                $this->ajax_response_manager->success(
                    [
                        'settings' => $settings,
                        'changed_fields' => count(array_diff_assoc($settings, $old_settings)),
                ...
                $this->ajax_response_manager->databaseError(
                    ...
                    [
                        'operation' => 'save_settings',
                        'user_id' => get_current_user_id(),
                        'attempted_settings_count' => count($settings)
                    ]
                );
            }
        } catch (Exception $e) {
    ...
    public function handleDatabaseCheck() {
        ...
        try {
            ...
            $this->ajax_response_manager->success(
                $results,
                __('Sprawdzenie bazy danych zakończone pomyślnie', 'woow-admin-styler'),
    ...
    public function handleResetLiveSetting() {
        ...
        try {
            ...
            if (isset($default_settings[$option_id])) {
                ...
                if ($result !== false) {
                    $this->ajax_response_manager->success([
                        ...
                        'settings' => $current_settings
                    ], sprintf(__('Opcja %s została przywrócona do domyślnej wartości!', 'woow-admin-styler'), $option_id), 'setting_reset', [
                        'operation' => 'reset_live_setting',
                        'option_id' => $option_id
                    ]);
                } else {
            ...
            $this->ajax_response_manager->error($e->getMessage(), 'reset_live_setting_error', [
                'option_id' => $option_id ?? 'unknown'
            ]);
        }
    }
    ...
    public function handleSaveLiveEditSettings() {
        ...
        try {
            ...
            if ($result !== false) {
                ...
                ], __('Ustawienia live edit zostały zapisane pomyślnie!', 'woow-admin-styler'), 'live_edit_settings_saved', [
                    'operation' => 'save_live_edit_settings',
                    'updated_count' => count($settings)
                ]);
            } else {
            ...
            $this->ajax_response_manager->databaseError($e->getMessage(), 'save_live_edit_settings');
        }
    }
    ...
    public function handleCacheFlush() {
        ...
        try {
            ...
            $this->ajax_response_manager->success(
                ['cache_flushed' => true],
                __('Cache został wyczyszczony pomyślnie!', 'woow-admin-styler'),
                'cache_flushed',
                ['operation' => 'cache_flush']
            );
        } catch (Exception $e) {
            $this->ajax_response_manager->error($e->getMessage(), 'cache_flush_error');
        }
    }
    ...
    public function handleCacheStats() {
        ...
        try {
            ...
            $this->ajax_response_manager->success(
                $stats,
                __('Statystyki cache pobrane pomyślnie', 'woow-admin-styler'),
                'cache_stats_retrieved',
                ['operation' => 'cache_stats']
            );
        } catch (Exception $e) {
            $this->ajax_response_manager->error($e->getMessage(), 'cache_stats_error');
        }
    }
    ...
    public function handleMetricsReport() {
        ...
        try {
            ...
            $this->ajax_response_manager->success(
                $report,
                __('Raport metryk wygenerowany pomyślnie', 'woow-admin-styler'),
                'metrics_report_generated',
                ['operation' => 'metrics_report']
            );
        } catch (Exception $e) {
            $this->ajax_response_manager->error($e->getMessage(), 'metrics_report_error');
        }
    }
    ...
    public function handleSecurityScan() {
        ...
        try {
            ...
            $this->ajax_response_manager->success(
                $scan_results,
                __('Skan bezpieczeństwa zakończony pomyślnie', 'woow-admin-styler'),
                'security_scan_complete',
                ['operation' => 'security_scan', 'scan_type' => $scan_type]
            );
        } catch (Exception $e) {
            $this->ajax_response_manager->error($e->getMessage(), 'security_scan_error');
        }
    }
    ...
    public function handlePerformanceBenchmark() {
        ...
        try {
            ...
            $this->ajax_response_manager->success(
                $benchmark,
                __('Test wydajności zakończony pomyślnie', 'woow-admin-styler'),
                'performance_benchmark_complete',
                ['operation' => 'performance_benchmark']
            );
        } catch (Exception $e) {
            $this->ajax_response_manager->error($e->getMessage(), 'performance_benchmark_error');
        }
    }
    ...
    public function handleCSSRegenerate() {
        ...
        try {
            ...
            ], __('CSS został zregenerowany pomyślnie!', 'woow-admin-styler'), 'css_regenerated', [
                'operation' => 'css_regenerate'
            ]);
        } catch (Exception $e) {
            $this->ajax_response_manager->error($e->getMessage(), 'css_regenerate_error');
        }
    }
    ...
    public function handleMemoryStats() {
        ...
        try {
            ...
            $this->ajax_response_manager->success(
                $stats,
                __('Statystyki pamięci pobrane pomyślnie', 'woow-admin-styler'),
                'memory_stats_retrieved',
                ['operation' => 'memory_stats']
            );
        } catch (Exception $e) {
            $this->ajax_response_manager->error('Failed to get memory stats: ' . $e->getMessage(), 'memory_stats_error');
        }
    }
    ...
    public function handleForceMemoryOptimization() {
        ...
        try {
            ...
            $this->ajax_response_manager->success(
                $result,
                __('Optymalizacja pamięci zakończona pomyślnie', 'woow-admin-styler'),
                'memory_optimization_complete',
                ['operation' => 'force_memory_optimization']
            );
        } catch (Exception $e) {
            $this->ajax_response_manager->error('Memory optimization failed: ' . $e->getMessage(), 'memory_optimization_error');
        }
    }
